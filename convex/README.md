...
Вычисляется количество вершин выпуклой оболочки, лежащих внутри замкнутого заданного треугольника. Треугольник задаётся тремя его вершинами — произвольными точками плоскости.
...
Принадлежность точки треугольнику с помощью следствия из теоремы о взаимном расположении двух точек относительно прямой: если точки находятся по разные стороны относительно прямой, то векторные произведения имеют разные знаки, а значит их произведение отрицательно. Если же точки лежат по одну сторону относительно прямой, то знаки векторных произведений совпадают, значит, их произведение положительно. С помощью цикла мы проходим по точкам, входящим в выпуклую оболочку и определяем их принадлежность к заданному треугольнику.
